      ...
      <div className="aboutBox">
        <div className="upperAboutContainer">
          ...
          <div className="upperAboutContent">
            <h1>About Us</h1>
            <h3>Play to the beat.</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores explicabo similique cum. Sit consequatur sapiente tenetur officiis rem blanditiis alias veritatis saepe neque quasi quas tempore modi, odit ipsam vitae?</p>
          </div>
        </div>
